    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Rumah Sakit Add</h3>
            </div>
            <?php echo form_open('rumah sakit/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="NO.ANTRIAN" value="<?php echo $this->input->post('NO.ANTRIAN'); ?>" class="form-control" id="NO.ANTRIAN" />
